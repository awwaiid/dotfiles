...
-- function go_frame_or_desk(scr)
--    kpress(DEFAULT_MOD.."Down", function(scr) scr:switch_nth(math.mod(scr:get_index(scr:current())+3,scr:lcount(1)))),
...
function go_frame_or_desk(ws, dir)
	...
	elseif dir == "down"	then
        scr:switch_nth(math.mod(scr:get_index(scr:current())+3,scr:lcount(1)))
--		scr:switch_next()
--		scr:switch_next()
--		scr:switch_next()
--		WRegion.goto(scr:current():leftmost())
