...
global_bindings{
    ...
    -- Experimental...
    kpress("KP_1", function(s) s:switch_nth(6) end),
    kpress("KP_2", function(s) s:switch_nth(7) end),
    kpress("KP_3", function(s) s:switch_nth(8) end),
    kpress("KP_4", function(s) s:switch_nth(3) end),
    kpress("KP_5", function(s) s:switch_nth(4) end),
    kpress("KP_6", function(s) s:switch_nth(5) end),
    kpress("KP_7", function(s) s:switch_nth(0) end),
    kpress("KP_8", function(s) s:switch_nth(1) end),
    kpress("KP_9", function(s) s:switch_nth(2) end),
    kpress("KP_0", function(s) s:switch_nth(9) end),
    kpress("KP_Divide",   function() goto_nth_screen(1) end),
    kpress("KP_Multiply", function() goto_nth_screen(0) end),

    -- Magical...
--     kpress(SECOND_MOD.."KP_1", make_exec_fn("xkbd -text '\\Ca1'")),
--     kpress(SECOND_MOD.."KP_2", make_exec_fn("xkbd -text '\\Ca2'")),
--     kpress(SECOND_MOD.."KP_3", make_exec_fn("xkbd -text '\\Ca3'")),
--     kpress(SECOND_MOD.."KP_4", make_exec_fn("xkbd -text '\\Ca4'")),
--     kpress(SECOND_MOD.."KP_5", make_exec_fn("xkbd -text '\\Ca5'")),
--     kpress(SECOND_MOD.."KP_6", make_exec_fn("xkbd -text '\\Ca6'")),
--     kpress(SECOND_MOD.."KP_7", make_exec_fn("xkbd -text '\\Ca7'")),
--     kpress(SECOND_MOD.."KP_8", make_exec_fn("xkbd -text '\\Ca8'")),
--     kpress(SECOND_MOD.."KP_9", make_exec_fn("xkbd -text '\\Ca9'")),

    kpress(SECOND_MOD.."1", make_exec_fn("/home/awwaiid/bin/irssi-screen 1")),
    kpress(SECOND_MOD.."2", make_exec_fn("/home/awwaiid/bin/irssi-screen 2")),
    kpress(SECOND_MOD.."3", make_exec_fn("/home/awwaiid/bin/irssi-screen 3")),
    ...
    kpress(SECOND_MOD.."F11", goto_prev_screen),
    ...
    kpress(SECOND_MOD.."F2", make_exec_fn("/home/awwaiid/bin/terminal")),

    kpress(SECOND_MOD.."k", make_exec_fn("/usr/bin/xscreensaver-command -lock")),
    ...
    kpress(DEFAULT_MOD..KEYF12, make_bigmenu_fn("mainmenu")),
