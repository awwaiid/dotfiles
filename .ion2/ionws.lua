...
ionws_bindings{
    ...
    kpress(DEFAULT_MOD.."Control+Down", function(f) go_desk(f, "down") end),
    kpress(DEFAULT_MOD.."Control+Up", function(f) go_desk(f, "up") end),
    kpress(DEFAULT_MOD.."Control+Right", function(f) go_desk(f, "right") end),
    kpress(DEFAULT_MOD.."Control+Left", function(f) go_desk(f, "left") end),
